  ...
  return (
    <section className="px-4 md:px-6 py-16 md:py-24 bg-[#efeae0]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="p-8 md:p-12 lg:p-14 flex flex-col items-center text-center justify-center">
            ...
            <p className="font-display text-base md:text-lg text-[#3c362c] leading-relaxed mb-4 max-w-xl">
              Mètis est né d'une conviction simple : la sagesse ne devrait pas rester
              enfermée dans les amphithéâtres.
            </p>
            <p className="font-display text-sm md:text-base text-[#4a4438] leading-relaxed mb-8 max-w-xl">
